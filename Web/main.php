   ...
   <tr>
      <th>DOT
        <select name="DOT" id="DOT">
        	...
        	<option value="red">Ascending</option>
        	<option value="green">Descending</option>
        </select>
      </th>
      <th>TICS</th>
      <th>Tire Size</th>
...
<a href="test111.py" class="btn btn-success">Run python Code</a>
</div>
<?php

$pythonoutput = shell_exec("test111.exe");
